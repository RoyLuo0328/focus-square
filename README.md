...
- 260×260 半透明桌面计时器，到点放大为 420×420 提醒
...
2. 打开 DMG，将 **Focus Square 1.2** 拖入“应用程序”文件夹。
3. 从“应用程序”打开 Focus Square 1.2。
...
> 当前 v1.2.0 安装包是未签名的社区构建。源码公开可审查；正式签名和公证需要 Apple Developer 与 Windows 代码签名证书。
...
- **macOS 12+:** download the universal DMG, drag Focus Square 1.2 to Applications, then open it. The current community build is not notarized, so macOS may require Control-click → Open on first launch.
